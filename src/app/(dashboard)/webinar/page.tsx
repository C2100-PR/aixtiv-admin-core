...
import { deleteWebinar, getAllWebinar } from '@/actions/webinar-action'
            ...
            <TableBody>
              {element.map(el => (
                <TableRow key={el.id}>
                  ...
                  <TableCell>{el.webinarIdRoom}</TableCell>
                  <TableCell>{el.webinarUrlRoom}</TableCell>
                  <TableCell>
